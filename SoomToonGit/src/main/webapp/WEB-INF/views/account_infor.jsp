...
<script>
	$(function(){
		$("#nickname").click(function(){
			// 프로필 수정 창으로 이동
			location.href = "${PageContext.request.contextPath}/profile_update";
		});
		$("#widthdrawal").click(function(){
			//서비스 탈퇴창으로 이동
			location.href = "${PageContext.request.contextPath}/service_withdrawal";
		});
	});
</script>
<body>
		...
		<div class="alias-layout">
			<div class="alias-box">
				<div class="alias-innerBox">
					<span class="alias">이메일</span> 
					<span class="name">soomtoon@naver.com</span>
				</div>
			</div>
			<div class="under-line"></div>
		</div>
