...
<body>
	...
	<div class="write_container">
		<h1>게시글 수정</h1>
		<form class="write_form" action="${pageContext.request.contextPath}/editPost" method="post">
			...
			<input type="text" id="title" name="postTitle" value="${postTitle}">
			...
			<textarea style="resize: none;" id="content" name="postContent" rows="10">${postContent}</textarea>
