	...
	<div class="header">
		<div class="header-1">
			<div class="header-content">
				<a class="logo_container" id="logo_container" href="${pageContext.request.contextPath}/main">
					<img src="resources/img/Soomtoon_logo.png" class="logo_img">
				</a>
				<div class="menu-container">
					<a class="menu active" href="${pageContext.request.contextPath}/main"><p>웹툰</p></a>
				...
				<div class="user-menu-container">
					...
					<button id="user-info" class="menu-box">
					...
					<c:if test="${empty sessionScope.userId}">
						<button id="login-btn" class="login-button" type="button">로그인</button>
					</c:if>
				</div>
			</div>
			<div class="info-menu" id="info-menu">
				<a>
					<div class="user-name">
						<span class="name-text">${userInfo.alias }</span>
